...
<head>
    ...
    <style>
        ...
        #header{
            background-image: url('{{asset('topbanner.png')}}');
            min-height: 200px;
            background-size: 100%;
            opacity: 0.7;
        ...
        #businessimage{
            background-image: url('{{asset('Businesswoman_Laptop.png')}}');
...
<div class="container-fluid" id="header">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4">
            <img src="{{asset('bcs_logo.png')}}" class="img-fluid" alt="" srcset="">
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6" id="businessimage"></div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="card" style="width: 90%; margin: auto; background-color: rgb(186, 218, 85);">
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="" id="" cols="10" rows="4" class="form-control"></textarea><br/>
                        <div class="row">
                            <div class="col">
    ...
    <div class="container" style="background-color:#fff">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0px">
                <img src="{{asset('nextsection.png')}}" style="width: 100%; opacity: 0.5" alt="">
            </div>
        </div>
    </div><br/>
</div>
<div class="container-fluid" id="footer"><br/>
    <div class="row" style="width: 90%; margin:auto">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <img src="{{asset('bcs_logo_white.png')}}" style="width: 100%" alt="white bcs logo" srcset="">
            <br/><br/>
            <p class="lead">
