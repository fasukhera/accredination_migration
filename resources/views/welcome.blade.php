...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div id="main_content">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="contact-form-box" id="contact-form" novalidate="true" action="#" onsubmit="if(document.getElementById('agree').checked) { return true; }
                                    ...
                                    <div class="col-xl-6 form-group has-error has-danger">
                                        <div
                                            ...
                                            <input type="text" placeholder="Full name *" class="form-control"
                                                name="name" data-error="Full name is required" required="">
                            ...
                            <div class="about-box-layout1">
                                <ul class="figure-holder has-animation">
                                    <li class="animated-bg">
                                        <div
                                            class="translate-left-75 opacity-animation transition-200 transition-delay-10">
                        ...
                        <div class="col-lg-6 compress-right-side">
                            <div class="about-box-layout1">
                                <div class="content-holder has-animation">
                                    ...
                                    <div
                                        class="translate-bottom-75 opacity-animation transition-150 transition-delay-1600">
                                        <ul class="list-item">
            ...
            <!--=====================================-->
            <div class="col-12 d-flex align-items-center justify-content-center has-animation active-animation"
                style="padding-top: 35px;">
                <div class="feature-box-layout1">
                    <div class="translate-left-75 opacity-animation transition-150 transition-delay-10">
                        <video width="800" height="450" controls>
                            <source src="{{asset('we-are-accred-update.mp4')}}" type="video/mp4">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                                <div class="service-box-layout1">
                                    ...
                                    <p>We certify practical, relevant IT skills from foundation to expert level - with
                                        over
                                        90 certificates all aligned with SFIAplus. This means that wherever your field
                                        of
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-300">
                                <div class="service-box-layout1">
                                    ...
                                    <p>Flexible, modular study courses developed by the UK's leading university
                                        academics
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                                <div class="service-box-layout1">
                                    ...
                                    <p>We create partnerships with world class and respected AccrediNation bodies. We
                                        help
                                        build credible human resources by identifying appropriate AccrediNation
                                        solutions
            ...
            <section class="process-wrap-layout1 section-padding-md bg-color-light position-relative">
                <div class="container">
                    <div class="section-heading heading-dark heading-layout1 has-animation">
                        ...
                        <p class="heading-paragraph" style="font-size:18px">Take your IT career to the next level with
                            BCS professional
                            certification. Developed in collaboration with leading employers, our training programmes
                            help
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-sm-center flex-xl-row-reverse">
                                                <div class="item-icon sunset-orange">
                                                    <h2 class="counting-text counter pt-3" data-num="700000">700,000
                                                    </h2>
                                                </div>
                                                <div class="item-content">
            ...
            <section class="d-none progress-wrap-layout1 bg-gradient-layout2">
                <div class="progress-inner-wrap bg-position-center bg-no-repeat bg-size-cover parallaxie bg-size-cover bg-no-repeat bg-position-center"
                    ...
                    <div class="row gutters-50">
                        ...
                        <div class="col-lg-6 col-12 d-flex align-items-center justify-content-center has-animation">
                            <div class="feature-box-layout1">
                                ...
                                <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                                    <div class="sub-title">Grursus mal suada faci lisis Lorem ipsum dolarorit the more
                                        as
                                ...
                                <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-900">
                                    <p>Rsus mal suada and fadolorit to the consectetur elit. All the at Lorem to Ipsum
                                        ...
                                        Internet more then have that. The the Lorem to IInternet more dummy text tend.
                                    </p>
                                </div>
                            ...
                            <div class="indicator-wrap">
                                <svg class="dash-left" width="675" height="206">
                                    <g fill="none" stroke-width="2">
                                        ...
                                        <path class="dashed2" stroke="white" stroke-dasharray="6, 6"
                                            stroke-linecap="butt" stroke-linejoin="miter"
                                            d="M3.000,0.995 L3.000,100.997 L673.000,101.994 L673.000,207.995" />
                                    </g>
                                </svg>
                                <div class="indicator-img-right">
                                    <div
                                        class="translate-top-50 opacity-animation transition-100 transition-delay-2500">
                        ...
                        <div
                            ...
                            <div class="feature-box-layout1">
                                <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                                    <h3 class="item-title">Brainstorming, Researching, Planning and Strategizing Work
                                    </h3>
                                </div>
                                <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                                    <p>Grursus mal suada faci lisis Lorem ipsum dolarorit more a ametion at that and
                                        more
                                        consectetur elit. Vesti at bulum nec odio aea the dumm the more ipsumm ipsum to
                                        that
                                ...
                                <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-900">
                                    <ul class="list-layout1">
                                        <li>
                                            ...
                                            <p>Grursus mal suada faci lisis Lorem ipsum dolarorit more that ametion that
                                                at
                                                consectetur elit.</p>
                                        </li>
                                        <li>
                        ...
                        <div class="col-12 d-lg-flex align-items-center justify-content-center has-animation d-none">
                            <div class="indicator-wrap">
                                ...
                                <div class="indicator-img-left">
                                    <div
                                        class="translate-top-75 opacity-animation transition-100 transition-delay-2500">
                                        <img src="media/element/element2.png" alt="element">
                                    </div>
                                </div>
                            </div>
            ...
            <section class="testimonial-wrap-layout2 section-padding-md bg-color-accent2">
                <div class="container">
                    ...
                    <div class="col-lg-12 rc-carousel nav-control-layout1" data-loop="true" data-items="3"
                        data-margin="" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="700"
                        ...
                        data-r-large="2" data-r-large-nav="true" data-r-large-dots="false" data-r-extra-large="2"
                                        ...
                                        <div class="col-xl-6 form-group">
                                            <div
                                                ...
                                                <input type="email" placeholder="Email *" class="form-control"
                                                    name="email" data-error="Email is required" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 col-12">
                            <div
                                class="call-to-action-box-layout1 d-flex justify-content-xl-end justify-content-center">
                    ...
                    <div class="row has-animation">
                        <div class="col-lg-4 col-12">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                                <div class="blog-box-layout1">
                                    <div class="item-figure">
                                        <a href="blog-details.html"><img src="media/blog/blog1.jpg"
                                                alt="Blog Figure"></a>
                                    </div>
                                    <div class="item-content">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-300">
                                <div class="blog-box-layout1">
                                    <div class="item-figure">
                                        <a href="blog-details.html"><img src="media/blog/blog2.jpg"
                                                alt="Blog Figure"></a>
                                    </div>
                                    <div class="item-content">
                                        <ul class="mb--5 entry-meta meta-color-accent justify-content-between">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                                <div class="blog-box-layout1">
                                    <div class="item-figure">
                                        <a href="blog-details.html"><img src="media/blog/blog3.jpg"
                                                alt="Blog Figure"></a>
                                    </div>
                                    <div class="item-content">
                                        <ul class="mb--5 entry-meta meta-color-accent justify-content-between">
                ...
                <div class="container">
                    ...
                    <div class="rc-carousel nav-control-layout1" data-loop="true" data-items="3" data-margin="10"
                        ...
                        <div class="testimonial-box-layout1"
                            style="background:none; width:60%; height:40%; padding-left: 150px">
                        ...
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/aim.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1"
                            style="background:none; width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/cybg.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/ev.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/ibm.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/novartis.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/redhat.png')}}" alt="Brand-thumb" class="">
                        </div>
                        <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                            <img src="{{asset('img/santander.png')}}" alt="Brand-thumb" class="">
                        </div>
                    </div>
                </div>
            </section>
