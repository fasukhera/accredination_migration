                    ...
                    <div class="col-lg-2 d-flex justify-content-start">
                        <div class="temp-logo text-center">
                            <a href="index.html" class="default-logo">
                                <img src="<?php echo e(asset('logo.png')); ?>" alt="logo" class="img-fluid">
                            </a>
                            <a href="index.html" class="sticky-logo">
                                <img src="<?php echo e(asset('logo-black.png')); ?>" alt="logo" class="img-fluid">
                            </a>
                        </div>
                    </div>
...
<!--=              Navbar End           =-->
<!--=====================================-->
<?php /**PATH C:\xampp\htdocs\accredination.co.uk\resources\views/includes/header.blade.php ENDPATH**/ ?>