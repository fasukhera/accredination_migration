...
<div id="preloader" class="tlp-preloader">
    <div class="animation-preloader">
        ...
        <img src="<?php echo e(asset('logo-black.png')); ?>" alt="Preloader">
    </div>
</div>
                        ...
                        <div class="translate-right-75 opacity-animation transition-150 transition-delay-2600">
                            <div class="main-banner-box-layout1">
                                <div class="item-figure">
                                    <img src="<?php echo e(asset('img\main.jpg')); ?>" alt="Illustration">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ul class="animated-shape has-animation">
                <li>
                    <div class="translate-right-75 opacity-animation transition-200 transition-delay-10">
                        <img src="<?php echo e(asset('media/element/element17.png')); ?>" alt="Animated Figure">
                    </div>
                </li>
            </ul>
            <div class="container-fluid">
                                ...
                                <li class="animated-figure">
                                    <div
                                        ...
                                        <div class="fa-pull-right">
                                            <img src="<?php echo e(asset('img/ice.png')); ?>" alt="ice">
                                        </div>
                                        <div class="" style="width: 40%;">
                                            <img src="<?php echo e(asset('img/ecmcc.png')); ?>" height="20%" alt="ecmcc">
                                        </div>
                                        <div style="text-align: center !important;">
                                            <img src="<?php echo e(asset('img/nicon.png')); ?>" alt="nicon">
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="container">
                ...
                <div class="rc-carousel nav-control-layout1" data-loop="true" data-items="3" data-margin="10"
                    ...
                    <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                        <img src="<?php echo e(asset('img/accenture.png')); ?>" alt="Brand-thumb" class="">
                    </div>
                    <div class="testimonial-box-layout1" style="width:60%; height:40%; padding-left: 150px">
                        <img src="<?php echo e(asset('img/accenture.png')); ?>" alt="Brand-thumb" class="">
                    </div>
        ...
        <section id="brand-wrap-layout1" class=" d-none brand-wrap-layout1 bg-color-accent2">
            <div class="container">
                <div class="rc-carousel" data-loop="true" data-items="8" data-margin="30" data-autoplay="false"
                    ...
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/accenture.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/astrazeneca.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/aviva.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/bank.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/barclyas.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/bt.jfif')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/delolite.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/llyods.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/RSA.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/sopra.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/telefonica.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/veritas.png')); ?>" alt="Brand-thumb"></div>
                    <div class="brand-box-layout1"><img src="<?php echo e(asset('img/world pay.png')); ?>" alt="Brand-thumb"></div>
        ...
        <div class="offcanvas-menu-wrap" id="offcanvas-wrap" data-position="left">
            ...
            <div class="offcanvas-content">
                <div class="offcanvas-logo">
                    <a href="index.html"><img src="<?php echo e(asset('logo-black.png')); ?>" alt="logo"></a>
                </div>
                <nav>
...
<!-- Dependency Scripts -->
<?php echo $__env->make('includes.dependencies', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script src="assets/js/app.js"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\accredination.co.uk\resources\views/welcome.blade.php ENDPATH**/ ?>